    ...
    do
    {
        ...
        case INDEX_op_movcond_i32: /* DONE */ /* bitwise */
            ...
            */
            ...
            /* (C1 cond C2 ? T1 : T2) */
            tcg_gen_movcond_i32(op_ptr->args[5], temp_i32_arg[1], arg_i32_tcgv(op_ptr->args[1]), 
                                arg_i32_tcgv(op_ptr->args[2]), shadow_i32_arg[3], shadow_i32_arg[4]);
        ...
        case INDEX_op_st_i32:    /* DONE */
            ...
            break;
        /* arith */
        case INDEX_op_add_i32: /* DONE */ /* bytewise */ /* FIXME */
            /*
                T -> Taint
                V -> Value
                T0 = 0xFFFFFFFF if T1 | T2
                else T0 = 0
            */
            shadow_i32_arg[0] = (TCGv_i32)find_shadow_arg(op_ptr->args[0]);
            shadow_i32_arg[1] = (TCGv_i32)find_shadow_arg(op_ptr->args[1]);
            ...
            temp_op = QTAILQ_NEXT(op_ptr, link);
            break;
        case INDEX_op_sub_i32: /* DONE */ /* bytewise */ /* FIXME */
            /*
                T -> Taint
                V -> Value
                T0 = 0xFFFFFFFF if T1 | T2
        ...
        case INDEX_op_st_i64:    /* DONE */
            ...
            break;
        /* arith */
        case INDEX_op_add_i64: /* DONE */ /* bytewise */ /* FIXME */
            /*
                T -> Taint
                V -> Value
                T0 = 0xFFFFFFFF if T1 | T2
        ...
        case INDEX_op_qemu_ld_i32:  /* DONE */            
            shadow_i32_arg[0] = (TCGv_i32)find_shadow_arg(op_ptr->args[0]);
            temp_i32_oi = tcg_constant_i32(op_ptr->args[2]);
