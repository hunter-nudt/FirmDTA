...
<title>Configuration Restore failed!</title>
...
function start(){
	...
	setContent("msg_line1",popup_msg[popup_msg_56]);
  	...
  	<td width="100%" height="80" align="center" valign="top">
    	  ...
    	  <tr>
      	  <td height="30" class="bggrey">
      	  	<span id="msg_line1" name="msg_line1"></span><br>
        		<span id="error" name="error"></span>: <% geterrstr(); %>
        	</td>
      	</tr>               
    	</table>
    </td>
