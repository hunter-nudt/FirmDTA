...
function jscolor_init() {
	...
	function createDialog() {
		...
		setStyle(elements.dialog, {
			...
			'background' : "url('"+dir+"img/"+"hv"+HVSize[0]+'x'+HVSize[1]+".png') "+padding+"px "+padding+"px no-repeat ThreeDFace"
		})
		...
		setStyle(elements.hv, {
			...
			'height' : HVSize[1]+2*padding+'px',
			'background' : "url('"+dir+"img/"+"cross.gif') no-repeat",
			'cursor' : 'crosshair'
		})
		...
		setStyle(elements.s, {
			...
			'height' : HVSize[1]+2*padding+'px',
			'background' : "url('"+dir+"img/"+"s.gif') no-repeat"
		})
		// IE 5 fix
		try {
