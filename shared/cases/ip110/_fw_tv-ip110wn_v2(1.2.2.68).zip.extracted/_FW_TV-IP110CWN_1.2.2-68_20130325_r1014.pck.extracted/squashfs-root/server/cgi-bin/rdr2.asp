...
function start(){
	...
	var begin = "<%getIframePage();%>";
	type = BrowserCheck();
	
	if(type == 1)
		window.location = "view.cgi?profile=5&language="+begin+"";
	else if(type == 2)
		window.location = "view.cgi?profile=2&language="+begin+"";
	else if(type == 3)
		window.location = "view.cgi?profile=7&language="+begin+"";
}
</script>
</head>
<body onload="start();">
