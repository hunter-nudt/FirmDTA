        	...
        	<tr>
          	<td align="center">
          		<p align="center" id="viewerTR" name="viewerTR">
		          	<object classid="CLSID:<% getactivexclsid(); %>" codebase="./<% getactivexname(); %>#version=<% getactivexver(); %>" width="320" height="240" align="middle" id="ucx" title="ActiveX Streaming Client">
		            <embed width="320" height="240" align="middle"></embed>
		            <br />
		            <b>ActiveX is not installed.</b>
		            </object>
		          </p>
		        </td>
        	</tr>
