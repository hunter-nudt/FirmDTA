...
function ip4_obj(ip, min_range, max_range, e_msg1, e_msg2){
	...
	this.e_msg1 = LangMap.msg[e_msg1];
	this.e_msg2 = LangMap.msg[e_msg2];
}
function change_wan(){
    var html_file;
	...
	switch(value){
		...
		case '10' :
	    	...
	    	break;
		case '11' :
			html_file = "wan_tm_poe.asp";
	    	break;
		case '16' :
			html_file = "wan_sg_dhcp.asp";
	    	break;
	}
	setTimeout(function() {
...
/*
**	check whether has unsaved data or not before page change and warning out.
*/
function jump_if(){
