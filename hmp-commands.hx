...
ERST

    {
        ...
        .args_type  = "",
        .params     = "",
        .help       = "list all process",
        .cmd        = do_list_all_proc,
    },

SRST
``list_all_proc`` [*cmd*]
  List guest's all process
ERST

    {
        ...
        .args_type  = "",
        .params     = "",
        .help       = "list modules in kernel",
        .cmd        = do_list_kernel_modules,
    },

SRST
``list_kernel_modules`` [*cmd*]
  List modules in kernel
ERST

    {
        .name       = "list_modules_by_pid",
        .args_type  = "pid:i",
        .params     = "pid",
...
SRST
``enable_tainting_internal`` [*cmd*]
  Enable taint in system
ERST
...
SRST
``disable_tainting_internal`` [*cmd*]
  Disable taint in system
ERST

    {
        .name       = "mark_taint_msg",
        .args_type  = "url:s,label:s,start:i,len:i",
        .params     = "[url] [label] [start] [len]",
        .help       = "provide mark msg to taint detection module",
        .cmd        = do_mark_taint_msg,
    },

SRST
``do_mark_taint_msg`` [*cmd*]
  Provide mark msg to taint detection module
ERST

    {
        .name       = "mark_taint_addr",
        .args_type  = "addr:l,size:i",
        .params     = "[addr] [size]",
        .help       = "Mark taint at 'addr' with 'size",
        .cmd        = do_mark_taint_addr,
    },

SRST
``do_mark_taint_addr`` [*cmd*]
  Mark taint at 'addr' with 'size'.
ERST
